      ...
      <div className="flex h-screen bg-gray-900">
        ...
        <div className="w-1/2 h-full flex flex-col border-r border-gray-700 bg-gray-800 text-gray-100">
          ...
          <div className="p-8 px-20 h-full w-full flex flex-col items-center justify-center text-center">
            ...
            <form hx-target="#ranksdiv" class="space-y-4" id='form' hx-encoding='multipart/form-data' hx-post='/handleResume'>
              <input
                id="name"
                name="name"
          ...
          {/* Chat Section */}
          <div className="flex-grow flex flex-col rounded-lg px-4 py-6 text-center text-lg border-t border-gray-800 bg-gray-800" id="chat-messages">
