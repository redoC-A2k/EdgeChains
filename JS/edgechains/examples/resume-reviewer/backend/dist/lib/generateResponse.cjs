...
const profileSchema = zod_1.z.object({
    ...
    expectedMinPayCurrency: zod_1.z
        .string()
        .default("INR")
    ...
    githubLink: zod_1.z
        ...
        .url()
        .optional()
        .describe("The link to the candidate's GitHub profile."),
    twitterLink: zod_1.z
        .string()
        .url()
        .optional()
        .describe("The link to the candidate's Twitter profile."),
    linkedinLink: zod_1.z
        .string()
        .url()
        .optional()
