...
try {
    ...
    if (!completionResponse.content) {
        const functionCallName = (_a = completionResponse === null || completionResponse === void 0 ? void 0 : completionResponse.function_call) === null || _a === void 0 ? void 0 : _a.name;
        if (functionCallName === "lookupTime") {
            const completionArguments = JSON.parse((_b = completionResponse === null || completionResponse === void 0 ? void 0 : completionResponse.function_call) === null || _b === void 0 ? void 0 : _b.arguments);
            const completion_text = await lookupTime(completionArguments.location);
            console.log(completion_text);
        }
        else if (functionCallName === "lookupWeather") {
            const completionArguments = JSON.parse((_c = completionResponse === null || completionResponse === void 0 ? void 0 : completionResponse.function_call) === null || _c === void 0 ? void 0 : _c.arguments);
